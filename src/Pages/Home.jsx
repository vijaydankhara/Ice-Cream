      ...
      <div id='ScrollMenu' className='w-full'>
         <div className='flex w-full h-[350px]'>
          ...
          <div className='overflow-hidden w-1/3'>
           <div className='bg-cover bg-no-repeat flex justify-center overflow-hidden hover:scale-110 duration-1000 h-full'style={{backgroundImage: `url(${img18})`}}> 
           ...
           <div className='bg-cover bg-no-repeat flex justify-around items-center overflow-hidden hover:scale-110 duration-1000 h-full'style={{backgroundImage: `url(${img19})`}}>
           <div className='z-10 bg-cover flex h-[120px] w-[120px] justify-center items-center text-[25px] text-white' style={{backgroundImage: `url(${spin})`}}>-30%</div>
           <div className='opacity-0'>hello</div>
           </div>
           </div>

           <div className='overflow-hidden w-1/3 h-[350px]'>
           <div className='bg-cover bg- h-full bg-no-repeat flex justify-center overflow-hidden hover:scale-110 duration-1000 'style={{backgroundImage: `url(${img17})`}}>

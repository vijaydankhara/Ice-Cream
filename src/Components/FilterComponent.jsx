  ...
  return (
    <div className="p-4  rounded-lg  w-96">
      ...
      <div className="mb-4">
        ...
        <ul>
          {['Caramel Ice Cream', 'Frozen Yogurt', 'Ice Cream Cakes', 'Milkshakes', 'Popsicles', 'Sundaes'].map((category, index) => (
      ...
      <div className="mb-4">
        ...
        <ul>
          {[
            { name: 'Mint Chip', price: '$10.00', image:{f1}},
            { name: 'Salty Caramel', price: '$12.00', image:{f2} },
            { name: 'Wedding Cake', price: '$15.00', image:{f3} },
          ].map((product, index) => (

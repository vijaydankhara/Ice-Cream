...
const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-[#b1ff3c] w-full h-28 flex justify-around items-center z-50  sticky top-0">
        <div className="container">
          ...
          {activeMenu === "mobile" && (
            <ul
              id="toggelmenuTop"
              className=" bg-[#ff6828] text-white text-xl font-bold space-y-4 py-4 px-4 w-full"
            >
              <li>
        ...
        <div
          className="w-full justify-evenly flex fixed bg-yellow-300 h-16 bottom-0"
          id="toggelHiden"
        >

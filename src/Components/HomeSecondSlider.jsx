...
const HomeSecondSlider = () => {
  return (
    <div
      className="w-full overflow-hidden h-auto flex flex-col lg:flex-row mt-5"
    ...
    >
      ...
      <div className="flex-1 lg:w-1/2 flex flex-col justify-center items-center lg:items-start text-center lg:text-left lg:px-8 py-8 lg:-ml-16">
        <h1 className="slider-font text-[#000000] text-2xl lg:text-6xl font-bold mb-4">
        ...
        <button
          className="mt-6 w-1/2 max-w-xs h-10  bg-[#fff] hover:bg-[#ff0000] flex items-center justify-center rounded-full border border-gray-300"

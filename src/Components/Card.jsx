...
const HomeProductCardMid = () => {
  ...
  return (
    <Card style={{ width: '18rem' }} className="ml-11 relative">
      <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        ...
        <div className="absolute top-[30%] left-[35%] items-center bg-white px-3 p-0.5 rounded-full text-center">
          Sold Out
        </div>
      </div>
      <Card.Body>
        <Card.Title className="mt-3">
Blackout Chocolate Cake</Card.Title>
        <Card.Text>
